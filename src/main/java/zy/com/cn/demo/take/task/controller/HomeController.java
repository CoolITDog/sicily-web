...
import zy.com.cn.demo.take.task.service.ShopCarService;
...
public class HomeController {
    ...
    @GetMapping("listFood")
    @ResponseBody
    public ResultEntity<List<FoodInfo>> listFoodsByCategoryId(@RequestBody(required = false) Integer categoryId){
        ...
        try{
            List<FoodInfo> list = foodInfoService.listFoods(condition);
